<?php
session_start();
$_SESSION['selected_one_cookie'] = $_GET['selectedclasses'];
$_SESSION['classes_one_cookie'] = $_GET['classes'];
...
//setcookie("selected_one_cookie", serialize($_POST['selectedclasses']), time()+36000);
//setcookie("classes_one_cookie", serialize($_POST['classes']), time()+36000);
?>
<!doctype html>
<html lang="en">
<head>
	...
	<div class="limiter">
		...
		<div class="container2-login100" style="padding-top: 65px;"  >
			<div class="wrap-login100" style="/*min-width: max-content;*/">
				...
				<form class="login100-form validate-form" action="SeniorDesign.php" method="GET" style="width: 100%;">
					
					<span class="login100-form-title" style="/*width:500px; text-align: left;*/">
						Select Upper Division Courses Taken
					</span>
					...
					<?php
								...
								$sql = "SELECT * FROM " .$major. " WHERE SD='0';";
								...
								while($row = $result->fetch_assoc()){
									...
									if($row['DIV']=='1'){
											...
											echo '<input type="hidden" name="classes2[]" id="classes2[]" value="'.$row['REQUIREMENTS'].'">';
											echo '<input type="checkbox" name="selectedclasses2[]" id="selectedclasses2[]" value="'.$row['REQUIREMENTS'].'">';
          ...
          <div class="container-login100-form-btn"><span class="login100-form-btn">
