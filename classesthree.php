...
session_start();
$_SESSION['senior_design_cookie'] = $_GET['seniordesign'];
	...
	<div class="limiter">
		...
		<div class="container2-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="Classes-Post.php" method="GET" style="width:100%;">
					
					<span class="login100-form-title" style="/*width:500px; text-align: left;*/">
						Select Breadth Courses Taken
					</span>
					...
					<?php
								...
								while($row = $result->fetch_assoc()){
											...
											echo '<input type="hidden" name="classes3[]" id="classes3[]" value="'.$row['REQUIREMENTS'].'">';
											echo '<input type="checkbox" name="selectedclasses3[]" id="selectedclasses3[]" value="'.$row['REQUIREMENTS'].'">';
